...
/**
 * FeeGroup filter form base class.
 *
 * @package    haimeeAct
 * @subpackage filter
 ...
 */
abstract class BaseFeeGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fee_group_filters[%s]');
