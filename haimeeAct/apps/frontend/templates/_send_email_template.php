...
<a style="color:#003580;font-family:Arial,Helvetica,sans-serif;font-size:12px;text-decoration:none;font-weight:bold" href="<?php echo url_for('@homepage', true) ?>" title="" target="_blank">
<img width="30" height="30" alt="Picture of <?php echo $user->getUsername()?>" src="<?php echo url_for('@homepage', true) ?>/uploads/avatar/<?php $avatar = $user->getSfGuardUserProfile()->getSmallAvatar(); echo $avatar ? $avatar : 'avatar.png' ?>"/></a>
</td>
</tr>
<tr>
<td align="right">
<a style="color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:12px;text-decoration:none;font-weight:bold" href="<?php echo url_for('@homepage', true) ?>" target="_blank">
&nbsp;<?php echo __('%first_name%', array('%first_name%' => $user->getFirstName()), 'sf_guard') ?>
</a>
</td>
</tr>
...
<tr>
<td width="600" align="center" style="display:block;font-size:20px;color:#003580;font-family:Arial,Helvetica,sans-serif;text-decoration:none;font-weight:bold">
	<?php if (!include_slot('header1')): ?>
